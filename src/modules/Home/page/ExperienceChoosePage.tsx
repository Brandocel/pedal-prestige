            ...
            <div className="relative mx-auto mt-[clamp(36px,3.3vw,48px)] w-full max-w-[1396px]">
              ...
              >
                {EXPERIENCE_OPTIONS.map((option) => (
                  ...
                  >
                  <h2
                    className="text-center text-[clamp(24px,1.8vw,28px)] leading-[1]"
                    style={{
                      fontFamily: "BaskervilleLocal, Libre Baskerville, serif",
                      fontWeight: 600,
                    }}
                  ...
                  <p
                    className="mt-[3px] text-center text-[clamp(16px,1.2vw,20px)] leading-[1] text-[#5C6670]"
                    style={{ fontFamily: "Hubballi, system-ui, sans-serif", fontWeight: 400 }}
                  >
                    {option.subtitle}
                  </p>
                  ...
                  <p
                    className="mt-[clamp(14px,1.3vw,18px)] text-[clamp(14px,1vw,16px)] leading-[1.4] text-[#2D3742]"
                  ...
                  <div className="mt-auto pt-[clamp(16px,1.5vw,20px)]">
                    <a
                      href={`/experience/checkout?option=${encodeURIComponent(option.id)}`}
                      className="inline-flex h-[clamp(38px,2.8vw,42px)] w-full items-center justify-center border border-[#8A9198] text-[clamp(11px,0.8vw,12px)] tracking-[0.06em] text-[#545B63]"
                      style={{ fontFamily: "Hubballi, system-ui, sans-serif", fontWeight: 400 }}
                    >
                      {option.cta}
                    </a>
